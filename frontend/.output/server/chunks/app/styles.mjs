...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.6098b83f.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.d56daa16.mjs').then(interopDefault),
