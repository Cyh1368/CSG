import { hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, isRef, defineComponent, h, onUnmounted, ref, computed, watch, Fragment, useSSRContext, createApp, effectScope, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, Text, defineAsyncComponent, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, Suspense, Transition } from 'vue';
import { d as useRuntimeConfig$1, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, $ as $fetch, n as sanitizeStatusCode, o as createHooks, q as isEqual, r as getRequestHeaders, t as defu } from '../nitro/node-server.mjs';
...
const appPageTransition = { "name": "Transition", "mode": "out-in" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/connection-f18f8b1e.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-70324b32.mjs').then((m) => m.default || m)
  },
  {
    name: "recommended_activities",
    path: "/recommended_activities",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/recommended_activities-e91f39f8.mjs').then((m) => m.default || m)
  },
  {
    name: "search-id",
    path: "/search/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-75f9cffd.mjs').then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-08c20095.mjs').then((m) => m.default || m)
  }
];
...
const plugin_BqLkNUef68 = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
  const { applicationId, apiKey, lite, recommend, cache: cache2 } = (/* @__PURE__ */ useRuntimeConfig()).public.algolia;
  ...
  const algoliaSearchClient = cache2 ? algoliasearch(applicationId, apiKey, { responsesCache: createInMemoryCache(), requestsCache: createInMemoryCache({ serializable: false }) }) : algoliasearch(applicationId, apiKey);
...
const layouts = {
  default: () => import('./_nuxt/default-a16b4aac.mjs').then((m) => m.default || m),
  error: () => import('./_nuxt/error-8798be81.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-a426cbaa.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-bca06538.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-648ce101.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useNuxtApp as a, useState as b, createError as c, useRuntimeConfig as d, entry$1 as default, useRouter as e, navigateTo as f, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRoute as u };
