...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Meta description"}],"link":[],"style":[],"script":[],"noscript":[],"titleTemplate":"CSG 歷程獵人"};
